...
return [
    ...
    */
    ...
    'features' => [
        // Self-registration is deliberately absent: this portal can push code to
        // every production appserver, so accounts are created by someone holding
        // users.manage (see `php artisan mwdeploy:create-user`).
