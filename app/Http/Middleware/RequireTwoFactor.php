 ...
 *
 * Accounts linked to the identity provider are exempt too — see
 * User::requiresTwoFactor(). The second factor is the provider's to enforce for
 * them, which is why an install relying on that should also switch password
 * sign-in off: a local password is a way in the provider never sees.
 */
