...
/**
 * The starting role set from section 3.5.2. Idempotent, so it is safe to re-run
...
final class RolesAndPermissionsSeeder extends Seeder
{
    ...
    private const ROLES = [
        'admin' => [
            'description' => 'Full access, including --force and user management',
            'permissions' => [
                ...
                P::REPOSITORIES_MANAGE, P::PATCHES_MANAGE, P::TARGETS_MANAGE, P::USERS_MANAGE,
            ],
        ],
        'deployer' => [
            'description' => 'Can deploy anything to production, but not --force and not the registry',
            'permissions' => [
                P::DEPLOY_CORE, P::DEPLOY_EXTENSION, P::DEPLOY_SKIN, P::DEPLOY_CONFIG,
        ...
        'extension-maintainer' => [
            'description' => 'Can deploy extensions and skins; scope further with repository_permissions',
            'permissions' => [
        ...
        'viewer' => [
            'description' => 'Read-only access to the repo browser and deployment history',
            'permissions' => [],
        ],
    ];
